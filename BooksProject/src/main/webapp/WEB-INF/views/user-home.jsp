...
<center>
	...
	<br><br>
	<a href="${contextPath}/book/add"><button class="btn btn-success">Add new books</button></a>
	
	<br>
	<br>
	<br>
	<br>
<a href="${contextPath}/book/publisherList"><button class="btn btn-primary">View the books you have added</button></a>
